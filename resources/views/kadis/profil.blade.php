...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                <div class="card card-widget widget-user">
                    ...
                    <h3 class="widget-user-username">KEPALA DINAS KESEHATAN</h3>
                    <h5 class="widget-user-desc">KOTA BANJARMASIN</h5>
                    </div>
                    <div class="widget-user-image">
                    <img class="img-circle elevation-2" src="/theme/pemko.png" alt="User Avatar">
                    </div>
        ...
        <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="/kadis/profil">
                @csrf
              <div class="card-body">
