...
<div class="row">
    <div class="col-md-12">
        <h4>SETTING KA.RUANGAN  RSUD SULTAN SURIANSYAH</h4>
        <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">SETTING KA.RUANGAN RSUD SULTAN SURIANSYAH</h3>
  
                </div>
                
                <form method="POST" action="/superadmin/manajemen/ruangan/kepala">
                    @csrf
                    @method('PUT')
