            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                    ...
                    <a href="/superadmin/libur_nasional/add" class="btn btn-xs btn-info" data-toggle="tooltip" title='Tambah'><i class="fas fa-plus"></i> Tambah Data</a>
                  ...
                  <table class="table table-hover text-nowrap table-sm table-striped">
                    ...
                    @foreach ($data as $key => $item)
                          <tr>
                            ...
                            <td>
                                <a href="/superadmin/libur_nasional/delete/{{$item->id}}" class="btn btn-xs btn-danger" data-toggle="tooltip" title='Hapus Jabatan' onclick="return confirm('Yakin ingin di hapus?');"><i class="fas fa-trash"></i></a>
                            </td>
                          </tr>
                      @endforeach
                    </tbody>
